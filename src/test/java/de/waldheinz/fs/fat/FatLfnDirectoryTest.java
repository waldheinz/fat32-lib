...
public class FatLfnDirectoryTest {
    ...
    @Test
    public void testAddDirectoryWithSameShortnameAsFileCorruptsFatReadFromDevice() throws Exception {
        System.out.println("testAddDirectoryWithSameShortnameAsFileCorruptsFatReadFromDevice");
        ...
        FatLfnDirectory root = testFs.getRoot();
        assertFalse ("Shortname bundle~1.jar shouldn't be available", root.isFreeName("bundle~1.jar"));
        assertTrue ("Shortname bundle~2.jar should be available", root.isFreeName("bundle~2.jar"));
        root.addDirectory("bundle.jar-embedded");
        assertFalse ("Shortname bundle~2.jar shouldn't be available", root.isFreeName("bundle~2.jar"));
    }
}
